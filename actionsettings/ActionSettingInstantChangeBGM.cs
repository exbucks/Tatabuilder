...
{
    public partial class ActionSettingInstantChangeBGM : ActionSettingBasePanel
    {
        public ActionSettingInstantChangeBGM()
        {
            InitializeComponent();
        }
        ...
        public override void LoadData()
        {
            ...
            // load action data
            TActionInstantChangeBGM myAction = (TActionInstantChangeBGM)this.action;
