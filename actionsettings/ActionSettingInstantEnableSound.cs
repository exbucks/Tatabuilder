...
{
    public partial class ActionSettingInstantEnableSound : ActionSettingBasePanel
    {
        public ActionSettingInstantEnableSound()
        {
            InitializeComponent();
        }
        ...
        public override void LoadData()
        {
            ...
            // load action data
            TActionInstantEnableSound myAction = (TActionInstantEnableSound)this.action;
