...
{
    public partial class ActionSettingInstantStopVoice : ActionSettingBasePanel
    {
        public ActionSettingInstantStopVoice()
        {
            InitializeComponent();
        }
        ...
        public override void LoadData()
        {
            ...
            // load action data
            TActionInstantStopVoice myAction = (TActionInstantStopVoice)this.action;
