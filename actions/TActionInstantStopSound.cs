...
{
    [Serializable]
    public class TActionInstantStopSound : TActionInstant
    {
        public string sound { get; set; }

        public TActionInstantStopSound()
        {
            name = "Stop Sound";
            icon = Properties.Resources.icon_action_stopsound;
        ...
        {
            if (xml == null || xml.Name != "ActionInstantStopSound")
                return false;
        ...
        public override XElement toXml()
        {
            ...
            xml.Name = "ActionInstantStopSound";
            xml.Add(
